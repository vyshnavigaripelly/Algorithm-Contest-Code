...
struct LinearRecurrence
{
    ...
    {
        function<int64(int64)> inverse = [&](int64 a) {
    ...
    static vec ReedsSloane(const vec &s, int64 mod)
    {
        ...
        vector<tuple<int64, int64, int>> fac;
...
int main()
{
    int t;
    scanf("%d", &t);
    vector<long long> f = {0, 5, 16, 88, 352, 1552, 6512, 27753, 117392, 497728, 2107952, 8930608, 37829456, 160251245, 148231586, 222584546, 507962972};
